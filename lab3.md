...
- ```-name``` - source = "https://www.computerhope.com/unix/ufind.htm"
  ```
...
- ```-type``` - source = "https://www.computerhope.com/unix/ufind.htm"
```
...
- ```-user``` - source = "https://www.computerhope.com/unix/ufind.htm"
```
